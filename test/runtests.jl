...
@testset "TensorGR.jl" begin
    ...
    # SpinIndex convenience layer (ergonomic spinor index creation)
    include("test_spin_index.jl")
    ...
    # Matter-graviton coupling vertices (Goldberger & Rothstein 2006)
    include("test_matter_vertices.jl")
