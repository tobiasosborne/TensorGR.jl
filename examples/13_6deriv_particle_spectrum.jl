...
bc_R3_(γ₁, Λ) = (a=0.0, b=6γ₁*Λ, c=0.0, e=24γ₁*Λ^2)
bc_RRicSq_(γ₂, Λ) = (a=0.0, b=γ₂*Λ, c=2γ₂*Λ, e=6γ₂*Λ^2)
bc_Ric3_(γ₃, Λ) = (a=0.0, b=0.0, c=(3/2)*γ₃*Λ, e=(3/2)*γ₃*Λ^2)
bc_RRiem2_(γ₄, Λ) = (a=4γ₄*Λ, b=(2/3)*γ₄*Λ, c=0.0, e=4γ₄*Λ^2)
bc_RicRiem2_(γ₅, Λ) = (a=γ₅*Λ, b=0.0, c=(2/3)*γ₅*Λ, e=γ₅*Λ^2)
bc_Riem3_(γ₆, Λ) = (a=2γ₆*Λ, b=0.0, c=0.0, e=(2/3)*γ₆*Λ^2)
